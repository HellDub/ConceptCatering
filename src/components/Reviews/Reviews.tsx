  ...
  const reviewData = [
    {
      ...
      review: `Buying meals from the plane sounded like a bad idea at first but with Ram Catering , I was able to enjoy my flight with a delicious meal.`,
      stars: 3,
      userName: 'Ahmad',
    ...
    {
      avatarSrc: '',
      review: `Beautiful Packs , good food and good service. I recommend it to everyone.`,
      stars: 4,
      userName: 'Ali',
    ...
    {
      avatarSrc: '',
      review: `I thought paying extra for such services was a waste of money, but I was wrong. I recommend it to everyone.`,
      stars: 5,
      userName: 'Zakaria',
